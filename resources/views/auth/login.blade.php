                ...
                <div class="flex items-center justify-center p-6 sm:p-12 md:w-1/2">
                    <div class="w-full">
                        ...
                        <form method="POST" action="{{ route('login') }}">
                            @csrf
                            <x-daisy.input class="mb-4" label="Email" placeholder="Jane Doe" name="email" value="{{ old('email') }}" autofocus
                                required />
                            ...
                            <x-daisy.input label="Password" placeholder="***************" type="password" name="password" required
